...
const DocumentValidationTab: React.FC<DocumentValidationTabProps> = ({ documents, setDocuments }) => {
      ...
      if (type === 'license') {
        ...
        setTimeout(() => {
          setDocuments((prev: any) => ({
            ...
            driverLicenseVerified: false, // Reset verification on new upload
          }));
        ...
        setTimeout(() => {
          setDocuments((prev: any) => ({
            ...
            nationalIdVerified: false, // Reset verification on new upload
          }));
  ...
  // Documents stay pending until admin approves them
  // No user-side verification available
  ...
  const DocumentCard = ({ 
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Upload Area */}
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-3">Upload {title}</label>
  ...
  return (
    <div className="p-8">
      ...
      <p className="text-gray-600 mb-8">Upload and verify your driver license and national ID card</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        <div className={`rounded-lg p-4 ${
          ...
          <p className={`text-sm ${
            ...
            {documents.driverLicenseVerified ? '✓ Verified' : documents.driverLicense ? '⏳ Pending' : '○ Not uploaded'}
          </p>
        </div>
        <div className={`rounded-lg p-4 ${
          ...
          <p className="font-semibold text-gray-900">Identification Document (CIN or Passport)</p>
          <p className={`text-sm ${
            documents.nationalIdVerified ? 'text-green-700' : 'text-yellow-700'
          }`}>
            {documents.nationalIdVerified ? '✓ Verified' : documents.nationalIdCard ? '⏳ Pending' : '○ Not uploaded'}
          </p>
        </div>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mt-8">
        ...
        <ul className="text-sm text-blue-800 space-y-1">
          ...
          <li>• Documents will be reviewed and verified by our admin team</li>
