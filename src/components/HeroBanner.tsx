export default function PromoBanner() {
  return (
    ...
    >
      ...
      {/* Content box */}
      <div className="relative z-10 px-6 py-8 bg-white/20 dark:bg-black/30 backdrop-blur-md rounded-2xl shadow-xl max-w-2xl mx-auto transition-colors duration-200">
        ...
        <p className="text-md md:text-lg text-white font-semibold mt-1">
          Hit the road with up to <span className="text-green-100 dark:text-green-200">25% off</span> car rental
        </p>
        ...
        <div className="mt-6">
          <a
            href="/car-deals"
            className="inline-block px-6 py-3 bg-green-600 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-600 text-white font-semibold rounded-xl shadow-md transition-all duration-300 hover:scale-105"
          >
            Search Deals
          </a>
        </div>
